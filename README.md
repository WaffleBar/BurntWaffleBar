...
- Icon themes: The Paladin, **The Ret Pally**, The Illidari, **The Fire Mage**, **The Resto Shammy**, **The BDK**, **The Sub Rogue**, and **all 13 retail classes** (Warrior, Hunter, Rogue, Priest, Shaman, Mage, Warlock, Monk, Druid, Death Knight, Evoker). Class themes are selected automatically by default; Ret Pally / Fire Mage / Resto Shammy / BDK / Sub Rogue are specialty packs you pick manually.
