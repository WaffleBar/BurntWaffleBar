...
- Icon themes: The Paladin, **The Ret Pally**, The Illidari, **The Fire Mage**, **The Resto Shammy**, and **all 13 retail classes** (Warrior, Hunter, Rogue, Priest, Shaman, Mage, Warlock, Monk, Druid, Death Knight, Evoker). Class themes are selected automatically by default; Ret Pally / Fire Mage / Resto Shammy are specialty packs you pick manually.
